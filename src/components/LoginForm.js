	...
	let auth_bool = false;
      ...
      .then(json => {
        ...
        if(json.password === this.refs.password.value){
          auth_bool = true;
          localStorage.setItem('session-username', JSON.stringify(json.username));
          localStorage.setItem('session-first_name', JSON.stringify(json.name));
          localStorage.setItem('enrolled', JSON.stringify(json.enrolled_subjects));
